...
*/
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  ...
  var H = x(E, 'perf', C()), K = x(H, 'g', C()), fa = x(H, 'i', C())
  x(H, 'r', [])
  C()
  C()
  ...
  var ia = /^(\/[a-zA-Z0-9_\-]+)+$/, T = [/\/amp\//, /\/amp$/, /^\/amp$/], ja = /^[a-zA-Z0-9\-_\.,!]+$/,
    ka = /^gapi\.loaded_[0-9]+$/, la = /^[a-zA-Z0-9,._-]+$/, pa = function(a, b, c, d) {
      ...
      e = V(a, 'rs')
      a = V(a, 't')
      return { pathPrefix: b, version: c, b: d, i: e, j: a }
    }, U = function(a) {
  ...
  var W = decodeURI('%73cript'), X = /^[-+_0-9\/A-Za-z]+={0,2}$/, ta = function(a, b) {
    ...
    k = x(G(c), 'r', []).sort()
    var Q = x(G(c), 'L', []).sort(), I = [].concat(k), ha = function(u, A) {
      if (z) return 0
      q.clearTimeout(y)
      Q.push.apply(Q, p)
  ...
  if (Z && Z.createPolicy) try {
    Da = Z.createPolicy('gapi#gapi', { createHTML: h, createScript: h, createScriptURL: h })
  } catch (a) {
...
gapi.load('', {
  callback: window['gapi_onload'], _c: {
    'jsl': {
      ...
      'h': 'm;/_/scs/apps-static/_/js/k\u003doz.gapi.ja.dA7e_MV3C1Y.O/am\u003dwQE/d\u003d1/ct\u003dzgms/rs\u003dAGLTcCMB-golB9pLy5dNFo8duTEgMs34ew/m\u003d__features__',
      'u': 'https://apis.google.com/js/api.js',
      'hee': true,
      'fp': 'a7523d1c7f64c49b60911b85b5c5f8499372cb6f',
      'dpo': false
    },
    'fp': 'a7523d1c7f64c49b60911b85b5c5f8499372cb6f',
